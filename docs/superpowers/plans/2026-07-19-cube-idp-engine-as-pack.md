...
- [ ] **Step 1: Extract the load-bearing values from the embedded blob**
...
- [ ] **Step 3: Write chart.yaml** (substitute CHART_PIN + MEDIA_TYPES)
...
- [ ] **Step 7: Write README.md** — engine-pack role, chart pin + bump
