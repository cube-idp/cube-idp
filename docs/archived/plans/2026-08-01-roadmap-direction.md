...
paths to re-evaluate after M5 based on how development goes. The committed
part is promoted into `docs/plans/ROADMAP.md` (the queue of record); this
document is the analysis and decision record behind it. Inputs: the
